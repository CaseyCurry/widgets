...
class Library {
    /**
     * @param {?} renderedWidgets
     * @param {?} availableWidgets
     */
    constructor(renderedWidgets, availableWidgets) {
    ...
    buildLibrary() {
        this.widgets = this.availableWidgets.map(widget => {
            const /** @type {?} */ isRendered = this.isWidgetRendered(widget);
...
class WidgetComponent {
     ...
     * @param {?} bootstrapService
     */
    constructor(document, elementRef, zone, bootstrapService) {
        this.document = document;
        this.elementRef = elementRef;
        this.zone = zone;
        this.bootstrapService = bootstrapService;
    ...
    notGrabbable(e) {
        ...
        const /** @type {?} */ target = e.target || e.srcElement;
        if (!target) {
            return true;
        }
    ...
    startMove(e) {
        ...
        const /** @type {?} */ userPosition = this.getUserPosition(e);
    ...
    getHeightInformation() {
        const /** @type {?} */ rect = this.elementRef.nativeElement
    ...
    ngAfterContentInit() {
        ...
        const /** @type {?} */ classes = this.bootstrapService.getClasses(this.widget);
    ...
    ngAfterViewInit() {
        ...
        this.zone.runOutsideAngular(() => {
            const /** @type {?} */ container = this.elementRef.nativeElement.querySelector('.container');
...
class LibraryComponent {
     ...
     */
    ngAfterViewInit() {
        const /** @type {?} */ width = this.elementRef.nativeElement
            .getBoundingClientRect()
            .width;
     ...
     * @return {?}
     */
    onCheckboxChange(libraryWidget) {
...
class DropTargetComponent {
    ...
    ngAfterContentInit() {
        ...
        const /** @type {?} */ classes = this.bootstrapService.getClasses(this.dropTarget);
        this.elementRef.nativeElement.classList.add(...classes);
    }
}
...
/** @nocollapse */
DropTargetComponent.ctorParameters = () => [
    { type: ElementRef, },
    { type: BootstrapService, },
];
 ...
 * @suppress {checkTypes} checked by tsc
 */
class ResizeGuidelineComponent {
    /**
     * @param {?} elementRef
     * @param {?} bootstrapService
     */
...
/** @nocollapse */
LayoutEditorComponent.ctorParameters = () => [
    { type: ElementRef, },
];
